...
const Home = ({API, navigation}) => {
  ...
  const [setSnackbar] = useState(false);
  ...
  return (
    <>
              ...
              <Card
                ...
                <LinearGradient
                  ...
                  <Text
                    ...
                    Located in Kenya at {item.store} under {item.section}{' '}
                    section
                  </Text>
                  <Text
                    style={{
                    ...
                    Modified on {item.ModifiedOn} by {item.ModifiedBy}
                  </Text>
                  <Chip
                    icon="information"
                    mode="outlined"
                  ...
                  <View
                    ...
                    <View>
                      ...
                      <LinearTextGradient
                        ...
                        locations={[0, 1]}
                        colors={['#43e97b', '#764ba2']}
                        start={{x: 1, y: 1}}
                        end={{x: 0, y: 0}}>
                        <Text>{item.PhysicalCount}</Text>
                      </LinearTextGradient>
                    </View>
                    <View style={{alignItems: 'center'}}>
                      <FAB
      ...
      <Snackbar
        ...
        style={{backgroundColor: '#750712'}}
        visible={!network.isInternetReachable}>
        This device is offline. Scanning cannot proceed.
      </Snackbar>
    </>
  );
};
